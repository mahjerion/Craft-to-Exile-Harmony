...
events.listen('rei.hide.items', function (event) {
  ...
  event.hide('hardcorequesting:item_barrel')
  event.hide('hardcorequesting:quest_tracker')
  event.hide('hardcorequesting:enabled_quest_book')
  event.hide('hardcorequesting:basic_bag')
  event.hide('hardcorequesting:good_bag')
  event.hide('hardcorequesting:greater_bag')
  event.hide('hardcorequesting:epic_bag')
  event.hide('hardcorequesting:legendary_bag')
  event.hide('hardcorequesting:hqm_invalid_item')
  event.hide('hardcorequesting:quarterheart')
  event.hide('hardcorequesting:threequartsheart')
  event.hide('hardcorequesting:heart')
  event.hide('hardcorequesting:rottenheart')
